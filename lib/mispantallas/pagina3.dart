...
class Pagina3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Carnes"), backgroundColor: Colors.red),
      drawer: const MenuLateral(),
      body: Column(
        children: [
          const Padding(padding: EdgeInsets.all(15), child: Text("Sección de Carnes", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.red))),
          Expanded(
